// Code generated by the Encore v1.43.9 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-exlibris-9yw2.encr.app`
}
...
/**
 * Client is an API client for the exlibris-9yw2 Encore application.
 */
...
export namespace content {
    ...
    export class ServiceClient {
        ...
        public async GetEntry(systemSlug: string, entrySlug: string): Promise<GetEntryResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/systems/${encodeURIComponent(systemSlug)}/entries/${encodeURIComponent(entrySlug)}`)
            return await resp.json() as GetEntryResponse
        }

        public async GetSystem(systemSlug: string): Promise<GetSystemResponse> {
            // Now make the actual call to the API
        ...
        public async ListCategories(systemSlug: string): Promise<ListCategoriesResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/systems/${encodeURIComponent(systemSlug)}/categories`)
        ...
        public async ListSystems(): Promise<ListSystemsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/systems`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "exlibris-9yw2-Generated-TS-Client (Encore/v1.43.9)";
        }
